...
def inject_user():
    """Injects username into all templates"""
    # Assisted by GPT
...
def customize():
    ...
    # Handle when customize is made from different pages
    if template == "index":
...
def get_entries():
    ...
    # For random poems in syncs page
    elif mode == 2:
    ...
    # For selected poem in syncs page
    elif mode == 3:
        poem = db.execute("""SELECT poem_type, line1_id, line1, line2_id, line2, line3_id,
    ...
    # For random poems in index page
    else:    
